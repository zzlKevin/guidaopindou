module.exports = [1, 0, 0, [
    ["cc.EffectAsset", ["_name", "shaders", "techniques"], 0]
  ],
  [
    [0, 0, 1, 2, 4]
  ],
  [
    [0, "builtin-unlit", [{
        ...
        defines: [{
          ...
          type: "boolean",
          defines: ["CC_USE_SKINNING", "CC_USE_JOINTS_TEXTRUE"]
        }, {
          ...
          type: "boolean",
          defines: ["CC_USE_ATTRIBUTE_UV0", "USE_DIFFUSE_TEXTURE"]
        }, {
          name: "INPUT_IS_GAMMA",
          type: "boolean",
          defines: ["CC_USE_ATTRIBUTE_UV0", "USE_DIFFUSE_TEXTURE"]
