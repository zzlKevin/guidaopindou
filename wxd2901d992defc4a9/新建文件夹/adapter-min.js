...
! function r(o, i, a) {
  ...
  2: [function(e, t, n) {
    ...
    var r = window.fsUtils,
      ...
      r = {
        ...
        _write: function _write() {
          y = !(g = null), u(this.cacheDir + "/" + this.cachedFileName, JSON.stringify({
            files: this.cachedFiles._map,
            version: this.version
          }), "utf8", function() {
            y = !1;
        ...
        writeCacheFile: function writeCacheFile(e) {
          g ? e && b.push(e) : (g = setTimeout(this._write.bind(this), this.writeFileInterval), !0 === y ? e && v.push(e) : e && b.push(e));
        },
        ...
        unzipAndCacheBundle: function unzipAndCacheBundle(t, e, n, r) {
          ...
          c(i, !0), p(e, i, function(e) {
            return e ? (d(i, !0), h(e.message) && (a.outOfStorage = !0, a.autoClear && a.clearLRU()), void(r && r(e))) : (a.cachedFiles.add(t, {
              bundle: n,
              url: i,
              lastTime: o
    ...
    cc.assetManager.cacheManager = t.exports = r;
  }, {}],
  3: [function(e, t, n) {
    ...
    var r,
      ...
      m = /^https?:\/\/.*/,
      g = {},
      y = cc.assetManager.downloader,
      v = cc.assetManager.parser,
      b = cc.assetManager.presets,
      w = __globalAdapter.isSubContext;
    y.maxConcurrency = 8, y.maxRequestsPerFrame = 64, b.scene.maxConcurrency = 10, b.scene.maxRequestsPerFrame = 64;
    var _ = {},
      E = {};
    ...
    function S(e, t, n) {
      ...
      var t = cc.sys;
      (t = (t.platform === t.TAOBAO ? window.document : document).createElement("audio")).src = e, n && n(null, t);
    }

    function T(r, t, o, e, i) {
      var n = L(r, o);
    ...
    function P(e, t, n) {
      T(e, D, t, t.onFileProgress, n);
    }
    var I = v.parsePVRTex,
      e = function e(_e2, n, r) {
        a(_e2, function(e, t) {
    ...
    y.downloadDomAudio = S, y.downloadScript = x, v.parsePVRTex = e, v.parsePKMTex = o, y.register({
      ".js": x,
      ".mp3": P,
      ".ogg": P,
      ".wav": P,
      ...
      bundle: function bundle(e, t, a) {
        var n,
          ...
          o = t.version || cc.assetManager.downloader.bundleVers[r];
        if (_[r]) {
          var i = "subpackages/".concat(r, "/config.").concat(o ? o + "." : "", "json"),
            u = function u() {
              A(i, t, function(e, t) {
          ...
          m.test(e) || !w && e.startsWith(h()) ? (c = e, n = "src/scripts/".concat(r, "/index.js"), l.makeBundleFolder(r)) : E[r] ? (c = "".concat(s, "remote/").concat(r), n = "src/scripts/".concat(r, "/index.js"), l.makeBundleFolder(r)) : (c = "assets/".concat(r), n = "assets/".concat(r, "/index.js")), __cocos_require__(n), t.__cacheBundleRoot__ = r;
          i = "".concat(c, "/config.").concat(o ? o + "." : "", "json");
          A(i, t, function(e, n) {
            var r, o, i;
            e ? a && a(e) : n.isZip ? (e = n.zipVersion, e = "".concat(c, "/res.").concat(e ? e + "." : "", "zip"), r = e, o = t, i = function i(e, t) {
            ...
            }) : l.unzipAndCacheBundle(r, r, o.__cacheBundleRoot__, i)) : (n.base = c + "/", a && a(null, n));
          });
        }
      },
      default: function _default(e, t, n) {
        T(e, N, t, t.onFileProgress, n);
      }
    }), v.register({
      ".png": y.downloadDomImage,
      ".jpg": y.downloadDomImage,
    ...
    w ? (j = cc.assetManager.init, cc.assetManager.init = function(e) {
  ...
  8: [function(e, t, n) {
    ...
    Object.assign(i, {
      ...
      _initRenderer: function _initRenderer() {
        var e, t;
        this._rendererInitialized || ((t = cc.sys).platform === t.TAOBAO ? this.frame = this.container = window.document.createElement("DIV") : this.frame = this.container = document.createElement("DIV"), e = __globalAdapter.isSubContext ? window.sharedCanvas || __globalAdapter.getSharedCanvas() : t.platform === t.TAOBAO ? window.canvas : canvas, this.canvas = e, this._determineRenderType(), this.renderType === this.RENDER_TYPE_WEBGL && (t = {
          stencil: !0,
  ...
  19: [function(e, t, n) {
    ...
    r.prototype.parseFromString = function(e, t) {
      ...
      }(i, o, a), r.domBuilder = n.domBuilder || o, u && (c[""] = "http://www.w3.org/1999/xhtml"), c.xml = c.xml || "http://www.w3.org/XML/1998/namespace", e ? r.parse(e, c, t) : r.errorHandler.error("invalid doc source"), o.doc;
    }, s.prototype = {
      ...
      startDTD: function startDTD(e, t, n) {
        ...
        r && r.createDocumentType && (n = r.createDocumentType(e, t, n), this.locator && l(this.locator, n), d(this, n));
      },
  ...
  20: [function(e, t, n) {
    ...
    var i,
      ...
      a = {},
      m = a.ELEMENT_NODE = 1,
      g = a.ATTRIBUTE_NODE = 2,
      y = a.TEXT_NODE = 3,
      v = a.CDATA_SECTION_NODE = 4,
      b = a.ENTITY_REFERENCE_NODE = 5,
      w = (a.ENTITY_NODE = 6, a.PROCESSING_INSTRUCTION_NODE = 7),
      _ = a.COMMENT_NODE = 8,
      E = a.DOCUMENT_NODE = 9,
      x = a.DOCUMENT_TYPE_NODE = 10,
      S = a.DOCUMENT_FRAGMENT_NODE = 11,
      c = (a.NOTATION_NODE = 12, {}),
      u = {};
    c.INDEX_SIZE_ERR = (u[1] = "Index size error", 1), c.DOMSTRING_SIZE_ERR = (u[2] = "DOMString size error", 2), c.HIERARCHY_REQUEST_ERR = (u[3] = "Hierarchy request error", 3), c.WRONG_DOCUMENT_ERR = (u[4] = "Wrong document", 4), c.INVALID_CHARACTER_ERR = (u[5] = "Invalid character", 5), c.NO_DATA_ALLOWED_ERR = (u[6] = "No data allowed", 6), c.NO_MODIFICATION_ALLOWED_ERR = (u[7] = "No modification allowed", 7), c.NOT_FOUND_ERR = (u[8] = "Not found", 8), c.NOT_SUPPORTED_ERR = (u[9] = "Not supported", 9), c.INUSE_ATTRIBUTE_ERR = (u[10] = "Attribute in use", 10), c.INVALID_STATE_ERR = (u[11] = "Invalid state", 11), c.SYNTAX_ERR = (u[12] = "Syntax error", 12), c.INVALID_MODIFICATION_ERR = (u[13] = "Invalid modification", 13), c.NAMESPACE_ERR = (u[14] = "Invalid namespace", 14), c.INVALID_ACCESS_ERR = (u[15] = "Invalid access", 15);

    function s(e, t) {
      var n;
      return t instanceof Error ? n = t : (n = this, Error.call(this, u[e]), this.message = u[e], Error.captureStackTrace && Error.captureStackTrace(this, s)), n.code = e, t && (this.message = this.message + ": " + t), n;
    }
    ...
    function f(e) {
      ...
      if (e._inc != t) {
        ...
        for (n in ee(e, "length", r.length), r) e[n] = r[n];
        e._inc = t;
      }
    }
    ...
    function N(e, t, n, r) {
      r ? t[O(t, r)] = n : t[t.length++] = n, !e || (t = (n.ownerElement = e).ownerDocument) && (r && R(t, e, r), e = e, n = n, (t = t) && t._inc++, "http://www.w3.org/2000/xmlns/" == n.namespaceURI && (e._nsMap[n.prefix ? n.localName : ""] = n.value));
    }
    ...
    function L(e, t) {
      var n = t.previousSibling,
        r = t.nextSibling;
      return n ? n.nextSibling = r : e.firstChild = r, r ? r.previousSibling = n : e.lastChild = n, j(e.ownerDocument, e), t;
    }

    function F(e, t, n) {
      var r = t.parentNode;
      if (r && r.removeChild(t), t.nodeType === S) {
        var o = t.firstChild;
        if (null == o) return t;
        var i = t.lastChild;
      } else o = i = t;
      r = n ? n.previousSibling : e.lastChild;
      for (o.previousSibling = r, i.nextSibling = n, r ? r.nextSibling = o : e.firstChild = o, null == n ? e.lastChild = i : n.previousSibling = i; o.parentNode = e, o !== i && (o = o.nextSibling);) return j(e.ownerDocument || e, e), t.nodeType == S && (t.firstChild = t.lastChild = null), t;
    }
    ...
    function J(e, t) {
      var n,
        ...
        i = o.prefix,
        a = o.namespaceURI;
      return Z(this, r, e, t, n = a && null == i && null == (i = o.lookupPrefix(a)) ? [{
        namespace: a,
        prefix: null
      }] : n), r.join("");
    }
      ...
      switch (e.nodeType) {
        case m:
          ...
          var i = e.attributes,
            ...
            c = e.firstChild,
            u = e.tagName;
          n = h === e.namespaceURI || n, t.push("<", u);
          for (var s = 0; s < a; s++) "xmlns" == (l = i.item(s)).prefix ? o.push({
            prefix: l.localName,
            namespace: l.value
          ...
          for (var l, f, d, s = 0; s < a; s++) Q(l = i.item(s), 0, o) && (f = l.prefix || "", d = l.namespaceURI, t.push(f ? " xmlns:" + f : " xmlns", '="', d, '"'), o.push({
            prefix: f,
            namespace: d
          })), Z(l, t, n, r, o);
          if (Q(e, 0, o) && (f = e.prefix || "", d = e.namespaceURI, t.push(f ? " xmlns:" + f : " xmlns", '="', d, '"'), o.push({
              prefix: f,
              namespace: d
            })), c || n && !/^(?:meta|link|img|br|hr|input)$/i.test(u)) {
            if (t.push(">"), n && /^script$/i.test(u))
              for (; c;) c.data ? t.push(c.data) : Z(c, t, n, r, o), c = c.nextSibling;
            else
              for (; c;) Z(c, t, n, r, o), c = c.nextSibling;
            t.push("</", u, ">");
          } else t.push("/>");
          return;
        case E:
        case S:
          for (c = e.firstChild; c;) Z(c, t, n, r, o), c = c.nextSibling;
          return;
        case g:
    ...
    s.prototype = Error.prototype, r(c, s), p.prototype = {
      ...
      toString: function toString(e, t) {
        for (var n = [], r = 0; r < this.length; r++) Z(this[r], n, e, t);
        return n.join("");
      }
      ...
      setNamedItem: function setNamedItem(e) {
        ...
        return N(this._ownerElement, this, e, t), t;
      },
      ...
      createDocument: function createDocument(e, t, n) {
        var r = new I();
        return r.implementation = this, r.childNodes = new p(), (r.doctype = n) && r.appendChild(n), t && (t = r.createElementNS(e, t), r.appendChild(t)), r;
      },
          ...
          switch (o.nodeType) {
            case m:
              var c = n.attributes,
                ...
                s = c.length;
              u._ownerElement = o;
              for (var l = 0; l < s; l++) o.setAttributeNode(e(t, c.item(l), !0));
              break;
            case g:
              r = !0;
          }
      ...
      normalize: function normalize() {
        for (var e = this.firstChild; e;) {
          var t = e.nextSibling;
          t && t.nodeType == y && e.nodeType == y ? (this.removeChild(t), e.appendData(t.data)) : (e.normalize(), e = t);
        }
      },
    ...
    }, r(a, C), r(a, C.prototype), I.prototype = {
      nodeName: "#document",
      nodeType: E,
      doctype: null,
      ...
      _inc: 1,
      insertBefore: function insertBefore(e, t) {
        if (e.nodeType != S) return null == this.documentElement && e.nodeType == m && (this.documentElement = e), F(this, e, t), e.ownerDocument = this, e;
      ...
      getElementById: function getElementById(t) {
        var n = null;
        return P(this.documentElement, function(e) {
          if (e.nodeType == m && e.getAttribute("id") == t) return n = e, !0;
        }), n;
      },
      createElement: function createElement(e) {
        var t = new k();
        return t.ownerDocument = this, t.nodeName = e, t.tagName = e, t.childNodes = new p(), (t.attributes = new T())._ownerElement = t;
      },
    ...
    }, o(I, C), I.prototype.getElementsByTagName = (k.prototype = {
      nodeType: m,
      ...
      appendChild: function appendChild(e) {
        return e.nodeType === S ? this.insertBefore(e, null) : function(e, t) {
          ...
          var r = e.lastChild;
          return t.parentNode = e, t.previousSibling = r, t.nextSibling = null, r ? r.nextSibling = t : e.firstChild = t, e.lastChild = t, j(e.ownerDocument, e, t), t;
        }(this, e);
      },
      ...
      getElementsByTagName: function getElementsByTagName(r) {
        return new l(this, function(t) {
          ...
          return P(t, function(e) {
            e === t || e.nodeType != m || "*" !== r && e.tagName != r || n.push(e);
          }), n;
        });
      },
      getElementsByTagNameNS: function getElementsByTagNameNS(r, o) {
        return new l(this, function(t) {
          var n = [];
          return P(t, function(e) {
            e === t || e.nodeType !== m || "*" !== r && e.namespaceURI !== r || "*" !== o && e.localName != o || n.push(e);
          }), n;
        });
      }
    }).getElementsByTagName, I.prototype.getElementsByTagNameNS = k.prototype.getElementsByTagNameNS, o(k, C), H.prototype.nodeType = g, o(H, C), B.prototype = {
      data: "",
      ...
      nodeType: v
    }, o(V, B), K.prototype.nodeType = x, o(K, C), G.prototype.nodeType = 12, o(G, C), z.prototype.nodeType = 6, o(z, C), q.prototype.nodeType = b, o(q, C), $.prototype.nodeName = "#document-fragment", $.prototype.nodeType = S, o($, C), X.prototype.nodeType = w, o(X, C), Y.prototype.serializeToString = function(e, t, n) {
      return J.call(e, t, n);
    }, C.prototype.toString = J;
    try {
    ...
    n.DOMImplementation = A, n.XMLSerializer = Y;
  }, {}],
  21: [function(e, t, n) {
  ...
  22: [function(e, t, n) {
    ...
    function H(e, t, n) {
      ...
      for (var s, i = e.length; i--;)(s = (a = e[i]).prefix) && ("xml" === s && (a.uri = "http://www.w3.org/XML/1998/namespace"), "xmlns" !== s && (a.uri = n[s || ""]));
      var l,
      ...
      parse: function parse(e, t, n) {
        ...
        r.startDocument(), p(t, t = {}),
          function(n, e, r, o, i) {
            ...
            function c(e, t) {
              for (; s <= e && (t = l.exec(n));) u = t.index, s = u + t[0].length, f.lineNumber++;
            ...
            for (;;) {
              try {
                var m,
                  g,
                  y = n.indexOf("<", h);
                if (y < 0) return n.substr(h).match(/^\s*$/) || (m = o.doc, g = m.createTextNode(n.substr(h)), m.appendChild(g), o.currentElement = g);
                switch (h < y && t(y), n.charAt(y + 1)) {
                  case "/":
                    var v = n.indexOf(">", y + 3),
                      b = n.substring(y + 2, v),
                      w = d.pop();
                    v < 0 ? (b = n.substring(y + 2).replace(/[\s<].*/, ""), i.error("end tag name: " + b + " is not complete:" + w.tagName), v = y + 1 + b.length) : b.match(/\s</) && (b = b.replace(/[\s<].*/, ""), i.error("end tag name: " + b + " maybe not complete"), v = y + 1 + b.length);
                    var _ = w.localNSMap,
                      E = w.tagName == b;
                    if (E || w.tagName && w.tagName.toLowerCase() == b.toLowerCase()) {
                      if (o.endElement(w.uri, w.localName, b), _)
                        for (var x in _) o.endPrefixMapping(x);
                    ...
                    f && c(y), v = function(e, t, n, r) {
                      {
                        if ("-" === e.charAt(t + 2)) {
                          ...
                          return t < o ? (n.comment(e, t + 4, o - t - 4), o + 3) : (r.error("Unclosed comment"), -1);
                        }
                        ...
                        if (1 < r && /!doctype/i.test(i[0][0])) {
                          o = i[1][0], e = 3 < r && /^public$/i.test(i[2][0]) && i[3][0], t = 4 < r && i[4][0], r = i[r - 1];
                          return n.startDTD(o, e && e.replace(/^(['"])(.*?)\1$/, "$2"), t && t.replace(/^(['"])(.*?)\1$/, "$2")), n.endDTD(), r.index + r[0].length;
                        }
                      }
                      return -1;
                    }(n, y, o, i);
                  ...
                  default:
                      ...
                      v = function(e, t, n, r, o, i) {
                        ...
                        for (;;) {
                          ...
                          switch (s) {
                            ...
                            case '"':
                              if (u === I || u === D) {
                                if (u === D && (i.warning('attribute value must after "="'), a = e.slice(t, c)), t = c + 1, !(0 < (c = e.indexOf(s, t)))) throw new Error("attribute value no end '" + s + "' match");
                                l = e.slice(t, c).replace(/&#?\w+;/g, o), n.add(a, l, t - 1), u = j;
                              } else {
                                if (u != R) throw new Error('attribute value must after "="');
                                l = e.slice(t, c).replace(/&#?\w+;/g, o), n.add(a, l, t), i.warning('attribute "' + a + '" missed start quot(' + s + ")!!"), t = c + 1, u = j;
                              }
                              break;
                            case "/":
                              switch (u) {
                            ...
                            case ">":
                              switch (u) {
                                ...
                                case P:
                                  u === P && (l = a), u == R ? (i.warning('attribute "' + l + '" missed quot(")!!'), n.add(a, l.replace(/&#?\w+;/g, o), t)) : ("http://www.w3.org/1999/xhtml" === r[""] && l.match(/^(?:disabled|checked|selected)$/i) || i.warning('attribute "' + l + '" missed value!! "' + l + '" instead!!'), n.add(l, l, t));
                                  break;
                                case I:
                            ...
                            default:
                              if (s <= " ") switch (u) {
                                ...
                                case P:
                                  n.tagName;
                                  "http://www.w3.org/1999/xhtml" === r[""] && a.match(/^(?:disabled|checked|selected)$/i) || i.warning('attribute "' + a + '" missed value!! "' + a + '" instead2!!'), n.add(a, a, t), t = c, u = D;
                                  break;
                                case j:
                    ...
                    if (!S.closed && function(e, t, n, r) {
                        ...
                        return o < t;
                      }(n, v, S.tagName, p) && (S.closed = !0, r.nbsp || i.warning("unclosed xml attribute")), f && O) {
                      for (var N = k(f, {}), M = 0; M < O; M++) {
                        var A = S[M];
                        c(A.offset), A.locator = k(f, {});
                      }
                      o.locator = N, H(S, o, T) && d.push(S), o.locator = f;
                    } else H(S, o, T) && d.push(S);
                    "http://www.w3.org/1999/xhtml" !== S.uri || S.closed ? v++ : v = function(e, t, n, r, o) {
  ...
  24: [function(e, t, n) {
    ...
    var r,
      i = (r = e("./HTMLAudioElement")) && r.__esModule ? r : {
        default: r
      };
    ...
    function s(n) {
      ...
      return function() {
        var e,
          t = l(n);
        return e = r ? (e = l(this).constructor, Reflect.construct(t, arguments, e)) : t.apply(this, arguments), t = this, !(e = e) || "object" !== o(e) && "function" != typeof e ? function(e) {
    ...
    var f = 0,
      ...
      v = function() {
        ...
        function o(e) {
          ...
          }(this, o), (t = r.call(this))._$sn = g++, t.HAVE_NOTHING = f, t.HAVE_METADATA = d, t.HAVE_CURRENT_DATA = p, t.HAVE_FUTURE_DATA = h, t.HAVE_ENOUGH_DATA = m, t.readyState = f;
          var n = wx.createInnerAudioContext();
          return y[t._$sn] = n, t._canplayEvents = ["load", "loadend", "canplay", "canplaythrough", "loadedmetadata"], n.onCanplay(function() {
        ...
        return e = o, (t = [{
          ...
          value: function value(e, t) {
            ...
            c(l(o.prototype), "addEventListener", this).call(this, e, t, n), e = String(e).toLowerCase(), this._loaded && -1 !== this._canplayEvents.indexOf(e) && this.dispatchEvent({
              type: e
            });
          }
        }, {
  ...
  26: [function(e, t, n) {
    ...
    function c(n) {
      ...
      return function() {
        var e,
          t = u(n);
        return e = r ? (e = u(this).constructor, Reflect.construct(t, arguments, e)) : t.apply(this, arguments), t = this, !(e = e) || "object" !== o(e) && "function" != typeof e ? function(e) {
          if (void 0 !== e) return e;
          throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
        }(t) : e;
      };
  ...
  32: [function(e, t, n) {
    ...
    var r,
      i = (r = e("./HTMLMediaElement")) && r.__esModule ? r : {
        default: r
      };
  ...
  34: [function(e, t, n) {
    ...
    var r,
      i = (r = e("./Element")) && r.__esModule ? r : {
        default: r
      },
      a = e("./util/index.js"),
      c = e("./WindowProperties");
    ...
    function l(n) {
      ...
      return function() {
        var e,
          t = f(n);
        return e = r ? (e = f(this).constructor, Reflect.construct(t, arguments, e)) : t.apply(this, arguments), t = this, !(e = e) || "object" !== o(e) && "function" != typeof e ? function(e) {
          if (void 0 !== e) return e;
          throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
        }(t) : e;
      };
  ...
  36: [function(e, t, n) {
    ...
    var r,
      i = (r = e("./HTMLElement")) && r.__esModule ? r : {
        default: r
      };
    ...
    function u(n) {
      ...
      return function() {
        var e,
          t = s(n);
        return e = r ? (e = s(this).constructor, Reflect.construct(t, arguments, e)) : t.apply(this, arguments), t = this, !(e = e) || "object" !== o(e) && "function" != typeof e ? function(e) {
          if (void 0 !== e) return e;
          throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
        }(t) : e;
      };
  ...
  40: [function(e, t, n) {
    ...
    var r,
      i = (r = e("./EventTarget.js")) && r.__esModule ? r : {
        default: r
      };
    ...
    var i = new WeakMap(),
      r = function() {
        function r(e) {
          ...
          if (! function(e, t) {
              if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
            }(this, r), this.binaryType = "", this.bufferedAmount = 0, this.extensions = "", this.onclose = null, this.onerror = null, this.onmessage = null, this.onopen = null, this.protocol = "", this.readyState = 3, "string" != typeof e || !/(^ws:\/\/)|(^wss:\/\/)/.test(e)) throw new TypeError("Failed to construct 'WebSocket': The URL '".concat(e, "' is invalid"));
  ...
  44: [function(e, t, n) {
    ...
    function s(n) {
      ...
      return function() {
        var e,
          t = c(n);
        return e = r ? (e = c(this).constructor, Reflect.construct(t, arguments, e)) : t.apply(this, arguments), t = this, !(e = e) || "object" !== o(e) && "function" != typeof e ? l(t) : e;
      };
    }
    ...
    var v = function() {
      ...
      function c() {
        ...
        return function(e, t) {
          if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
        }(this, c), (e = r.call(this)).timeout = 0, e.onabort = null, e.onerror = null, e.onload = null, e.onloadstart = null, e.onprogress = null, e.ontimeout = null, e.onloadend = null, e.onreadystatechange = null, e.readyState = 0, e.response = null, e.responseText = null, e.responseType = "", e.responseXML = null, e.status = 0, e.statusText = "", e.upload = {}, e.withCredentials = !1, p.set(l(e), {
      ...
      return e = c, (t = [{
        ...
        key: "open",
        value: function value(e, t) {
          d.set(this, e), f.set(this, t), y.call(this, c.OPENED);
        }
      }, {
          ...
          e = wx.request({
            ...
            success: function success(e) {
              var t = e.data,
                n = e.statusCode,
                e = e.header;
              switch (a.status = n, h.set(a, e), g.call(a, "loadstart"), y.call(a, c.HEADERS_RECEIVED), y.call(a, c.LOADING), a.responseType) {
                case "json":
                  a.responseText = t;
                  try {
              ...
              y.call(a, c.DONE), g.call(a, "load"), g.call(a, "loadend");
            },
            fail: function fail(e) {
              e = e.errMsg; -
              1 !== e.indexOf("abort") ? g.call(a, "abort") : -1 !== e.indexOf("timeout") ? g.call(a, "timeout") : g.call(a, "error", e), g.call(a, "loadend");
            }
          });
          m.set(this, e);
        }
  ...
  49: [function(e, t, n) {
    ...
    var i = o.system,
      ...
      e = o.language,
      o = o.version,
      i = !!i && -1 !== i.toLowerCase().indexOf("android") ? "Android; CPU ".concat(i) : "iPhone; CPU iPhone OS ".concat(i, " like Mac OS X"),
      o = "Mozilla/5.0 (".concat(i, ") AppleWebKit/603.1.30 (KHTML, like Gecko) Mobile/14E8301 MicroMessenger/").concat(o, " MiniGame NetType/WIFI Language/").concat(e),
      c = {
        platform: a,
        language: e,
  ...
  51: [function(e, t, n) {
    ...
    n.cancelAnimationFrame = T, n.requestAnimationFrame = S, n.clearInterval = o, n.clearTimeout = e, n.setInterval = N, n.setTimeout = O;
  }, {
    "./Audio": 24,
    "./Canvas": 25,
    "./EventIniter/index.js": 29,
  ...
  55: [function(e, t, n) {
    ...
    /**wx.onError && wx.onError(function e(t) {
        ...
        var n,
            ...
            o,
            i = Math.random() < .01;
        !__globalAdapter.isSubContext && i && (!(n = wx.getSystemInfoSync()) || (r = cc.Canvas.instance.node) && ((o = new cc.Node).color = cc.Color.BLACK, i = o.addComponent(cc.Label), o.height = r.height - 60, o.width = r.width - 60, i.overflow = cc.Label.Overflow.SHRINK, i.horizontalAlign = cc.Label.HorizontalAlign.LEFT, i.verticalAlign = cc.Label.VerticalAlign.TOP, i.fontSize = 24, i.string = "出错了，请截屏发送给游戏开发者（Please send this screenshot to the game developer）\nPlatform: WeChat " + n.version + "\nEngine: Cocos Creator v" + window.CocosEngine + "\nDevice: " + n.brand + " " + n.model + " System: " + n.system + "\nError:\n" + t.message, cc.LabelOutline && (o.addComponent(cc.LabelOutline).color = cc.Color.WHITE), o.once("touchend", function () {
            o.destroy(),
            setTimeout(function () {
                cc.director.resume()
            }, 1e3)
  ...
  56: [function(e, t, n) {
    ...
    var o = wx.getFileSystemManager ? wx.getFileSystemManager() : null,
      ...
      a = {
        ...
        initCdn: function initCdn(t) {
          if (typeof CDNS !== 'undefined' && CDNS.length > 1) {
        ...
        switchCdn: function switchCdn(t, e, n, r, o, cb) {
          a.initCdn(t);
          if (!a.nCdn) {
            cb && cb(t, e, n, r, o);
          } else {
            console.warn("[CDN主备切换] 主CDN下载失败，切换备用CDN | url: ".concat(t, " | 主CDN: ", a.oCdn, " | 备用CDN: ", a.nCdn)), t = t.replace(a.oCdn, a.nCdn), a.downloadFile(t, e, n, r, o, cb);
          }
        },
        downloadFile: function downloadFile(t, e, n, r, o, cb) {
          var i = {
            url: t,
            success: function success(e) {
              if (200 === e.statusCode) {
                o && o(null, e.tempFilePath || e.filePath);
              } else {
                if (!cb) {
                  a.switchCdn(t, e, n, r, o, function(t, e, o) {
                    e.filePath && a.deleteFile(e.filePath), console.warn("Download file failed: path: ".concat(t, " message: ").concat(e.statusCode)), o && o(new Error(e.statusCode), null);
                  });
                } else cb(t, e, o);
              }
            },
  ...
  58: [function(e, t, n) {
    ...
    window.__globalAdapter && (s = window.__globalAdapter, l = wx.getSystemInfoSync(), f = l.windowWidth, d = l.windowHeight, s.isSubContext = void 0 === wx.getOpenDataContext, s.isDevTool = "devtools" === l.platform, e.cloneMethod(s, wx, "getSystemInfoSync"), e.cloneMethod(s, wx, "onTouchStart"), e.cloneMethod(s, wx, "onTouchMove"), e.cloneMethod(s, wx, "onTouchEnd"), e.cloneMethod(s, wx, "onTouchCancel"), e.cloneMethod(s, wx, "createInnerAudioContext"), e.cloneMethod(s, wx, "onAudioInterruptionEnd"), e.cloneMethod(s, wx, "onAudioInterruptionBegin"), e.cloneMethod(s, wx, "createVideo"), e.cloneMethod(s, wx, "setPreferredFramesPerSecond"), e.cloneMethod(s, wx, "showKeyboard"), e.cloneMethod(s, wx, "hideKeyboard"), e.cloneMethod(s, wx, "updateKeyboard"), e.cloneMethod(s, wx, "onKeyboardInput"), e.cloneMethod(s, wx, "onKeyboardConfirm"), e.cloneMethod(s, wx, "onKeyboardComplete"), e.cloneMethod(s, wx, "offKeyboardInput"), e.cloneMethod(s, wx, "offKeyboardConfirm"), e.cloneMethod(s, wx, "offKeyboardComplete"), e.cloneMethod(s, wx, "getOpenDataContext"), e.cloneMethod(s, wx, "onMessage"), e.cloneMethod(s, wx, "getSharedCanvas"), e.cloneMethod(s, wx, "loadFont"), e.cloneMethod(s, wx, "onShow"), e.cloneMethod(s, wx, "onHide"), e.cloneMethod(s, wx, "onError"), e.cloneMethod(s, wx, "offError"), r = !1, a = 1, wx.onDeviceOrientationChange && wx.onDeviceOrientationChange(function(e) {
      ...
      var e,
        ...
        c = n.width,
        u = n.height;
      return "ios" === l.platform && !s.isDevTool && p() && (e = r, t = o, n = u, r = d - a, o = e, i = d - t - (t = f - (e = i)), a = e, u = c - t, c = n), {
        top: r,
        left: o,
        bottom: i,
        right: a,
